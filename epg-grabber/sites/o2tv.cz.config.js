...
module.exports = {
  ...
  url: function ({ channel, date }) {
    ...
    //console.log("d,g", d, g)
    return encodeURIComponent(`https://api.o2tv.cz/unity/api/v1/epg/depr/?forceLimit=true&channelKey=${id}&from=${d}`)
...
async function loadProgramDetails(item, channel) {
  ...
  const url = encodeURIComponent(`https://api.o2tv.cz/unity/api/v1/programs/${parseI(item)}/`)
